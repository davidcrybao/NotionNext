...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'JoyEasy每天开心', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '我喜欢很多东西，希望能坚持下来', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.202060.xyz/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客, Unity', // 网站关键词 英文逗号隔开
  ...
  CONTACT_TELEGRAM: process.env.NEXT_PUBLIC_CONTACT_TELEGRAM || 'https://t.me/Joyeass', // 你的telegram 地址 例如 https://t.me/tangly_1024
  ...
  ANALYTICS_GOOGLE_ID: process.env.NEXT_PUBLIC_ANALYTICS_GOOGLE_ID || 'G-4HYVYLQ6MT', // 谷歌Analytics的id e.g: G-XXXXXXXXXX
